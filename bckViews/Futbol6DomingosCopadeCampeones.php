...
<head>
  ...
  <title>Tablas 360 Masculino</title>
  ...
  <script type="text/javascript" src="../jscss/jquery-1.8.3.min.js" charset="ISO-8859-1"></script>

  <script type="text/javascript" src="../jscss/tablas_export.js?v=2" charset="ISO-8859-1"></script>
...
<div class="section-tabs">
  ...
  <div style="display: block;" class="posiciones-wrapper section">
...
?>            
	...
	<div class="fairplay list jugadores" id="tabla-fairplay-jugadores">
    	...
    	<div class="items">
			...
			<?php } ?>
                ...
                <div class="col col4"><?php echo $rowA['cantidadrojas']; ?></div>

                <div class="col col5"><?php echo $rowA['cantidadazules']; ?></div>
  ...
  <div style="display:none;" class="vallamenosvencida-wrapper section">
