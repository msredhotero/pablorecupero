...
$resFix = $serviciosPlayOff->traerArmarPlayOff($idTorneo, $idZona);
...
<h3><?php echo $lblTituloplural; ?></h3>
    ...
    <div class="boxInfoLargo">
    	...
    	<div class="cuerpoBox" style="padding-right:10px;">
            ...
            <input type="hidden" id="accion" name="accion" value="insertarEstadisticaPlayOff" />
            <input type="hidden" id="idplayoff" name="idplayoff" value="<?php echo $id; ?>" />
            </form>
    	</div>
    </div>
